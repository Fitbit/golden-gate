...
public extension LinkConfigurationService {
    struct PreferredConnectionConfiguration: CustomStringConvertible, Codable {
        ...
        public struct ModeConfiguration: CustomStringConvertible, Codable {
            ...
            public var slaveLatency: UInt8

            /// in units of 100 ms, valid range: 2 seconds to 6 seconds
            public var supervisionTimeout: UInt8
            ...
            public static let dummy = ModeConfiguration(min: 0, max: 0, slaveLatency: 0, supervisionTimeout: 0)

            public static let connectionIntervalValidRange = ValidRange<Double, Double>(min: 12, max: 1600, unit: 1.25)
            public static let slaveLatencyValidRange = ValidRange<UInt8, UInt8>(min: 0, max: 30, unit: 1)
        ...
        public struct DLEConfiguration: CustomStringConvertible, Codable {
            ...
            public static let dummy = DLEConfiguration(maxTxPDU: 0, maxTxTime: 0)
        }
