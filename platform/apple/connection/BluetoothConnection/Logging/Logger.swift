...
/// Simple logging interface for BluetoothConnection.
///
/// An application that wants BluetoothConnection to use its logging solution will need to provide a type that conforms to this
/// signature and assign it to `BluetoothConnection.defaultLogger`.
