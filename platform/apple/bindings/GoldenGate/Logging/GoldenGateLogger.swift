...
public enum GoldenGateLogger {
    ...
    public static func configureXpLogManager(_ configurationSources: String? = nil) {
        GG_LogManager_Configure(configurationSources?.cString(using: .utf8))
    }
}
