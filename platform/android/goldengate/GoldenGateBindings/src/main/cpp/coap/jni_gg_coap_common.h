...
#define COAP_RESPONSE_LISTENER_SET_NATIVE_LISTENER_REFERENCE_NAME "setNativeListenerReference"
...
#define COAP_RESPONSE_LISTENER_SET_NATIVE_LISTENER_REFERENCE_SIG "(J)V"
